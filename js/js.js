...
$(window).scroll((event) => {
  ...
  let footerOffset = $('.mdl-mini-footer').offset().top;
  ...
  'classList' in document.createElement('div') && 'querySelector' in document && 'addEventListener' in window && Array.prototype.forEach ? (document.documentElement.classList.add('mdl-js'), componentHandler.upgradeAllRegistered()) : componentHandler.upgradeElement = componentHandler.register = function () {};
    ...
    (function() {
      ...
      if (this.element_) {
          ...
          let s = this.element_.getAttribute('for'),
              i = null;
      ...
      if (this.element_ && this.forElement_) {
          let t = this.forElement_.getBoundingClientRect(),
      ...
      if (this.element_ && this.container_ && this.forElement_) {
          let t = this.element_.querySelectorAll('.' + this.CssClasses_.ITEM + ':not([disabled])');
      ...
      if (this.element_ && this.container_) {
          ...
          if (t && t.length > 0 && this.container_.classList.contains(this.CssClasses_.IS_VISIBLE)) {
              let s = Array.prototype.slice.call(t).indexOf(e.target);
      ...
      if (this.element_ && this.container_ && this.outline_) {
          let t = this.element_.getBoundingClientRect().height,
      ...
      if (this.element_ && this.container_ && this.outline_) {
          ...
          let s = this.element_.getBoundingClientRect().height,
      ...
      for (let t = document.getElementsByClassName(this.CssClasses_.JS_RADIO), s = 0; s < t.length; s++) {
          let i = t[s].querySelector('.' + this.CssClasses_.RADIO_BTN);
      ...
      let t = (this.element_.value - this.element_.min) / (this.element_.max - this.element_.min);
      ...
      if (this.element_) {
          let e = this.element_.getAttribute('for');
...
i;
      ...
      if (this.element_) {
          let e = this.element_.querySelector('th'),
      ...
      if (!this.rippleElement_.style.width && !this.rippleElement_.style.height) {
          let t = this.element_.getBoundingClientRect();
...
a = e.currentTarget.getBoundingClientRect();
          if (e.clientX === 0 && e.clientY === 0) i = Math.round(a.width / 2), n = Math.round(a.height / 2);
              ...
              let l = e.clientX ? e.clientX : e.touches[0].clientX,
      ...
      if (this.element_) {
          let e = this.element_.classList.contains(this.CssClasses_.RIPPLE_CENTER);
...
$(document).ready(() => {
  ...
  let sidebar = $('#sidebar');
  let sidebarHeader = $('#sidebar .sidebar-header');
  let sidebarImg = sidebarHeader.css('background-image');
  let toggleButtons = $('.sidebar-toggle');
...
(function () {
  ...
  let burger = document.querySelector('.MD-burger-icon');
